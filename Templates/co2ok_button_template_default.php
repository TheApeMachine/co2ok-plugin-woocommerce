<div class="co2ok_container" data-cart="<?php echo $cart ?>">
    ...
    <div class="co2ok_infobox_container co2ok-popper">
        ...
        <a class="hover-link" target="_blank" href="http://co2ok.eco"><?php echo co2ok_plugin_woocommerce\Components\Co2ok_HelperComponent::RenderImage('images/logo.svg', 'co2ok_logo', 'co2ok_logo'); ?></a>
