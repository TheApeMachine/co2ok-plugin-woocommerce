<div class="co2ok_container co2ok_container_default" data-cart="<?php echo $cart ?>">
        ...
        <div id="checkbox_label">
            <a href="#!" input type="button" role="button" tabindex="0" style="outline: none; -webkit-appearance: none; background-color: transparent !important; z-index: 9999;">
                <div class="inner_checkbox_label inner_checkbox_label_default co2ok_global_temp" id="default_co2ok_temp">
                    ...
                    <span class="make make_co2ok_default"><?php echo __( 'Offset this footprint ', 'co2ok-for-woocommerce' ); ?> </span>
                    <?php 
                    ...
                    echo co2ok_plugin_woocommerce\Components\Co2ok_HelperComponent::RenderImage('images/south_pole_logo.png', 'co2ok_logo', 'co2ok_logo_default', 'co2ok_logo', 'skip-lazy'); 
                    ?>
    ...
    <span class="co2ok_payoff">
        <span class="co2ok_payoff_text co2ok_adaptive_color_default">
                <span>
                    <?php
                        echo  __( 'Compensate the climate impact of my purchase', 'co2ok-for-woocommerce' );
                        ?>
                </span>
                <span>
                    <?php
        ...
        <span id="p">
            <span class="co2ok_info_hitarea">
                <?php echo co2ok_plugin_woocommerce\Components\Co2ok_HelperComponent::RenderImage('images/info_sp.svg', 'co2ok_info', 'co2ok_info'); ?>
            </span>
        </span>
        </a>
