    ...
    <span class="co2ok_checkbox_container co2ok_checkbox_container_default cfp-selected>">
        ...
        <div id="checkbox_label">
            <a href="#!" input type="button" role="button" tabindex="0" style="outline: none; -webkit-appearance: none;">
				<div class="inner_checkbox_label inner_checkbox_label_default co2ok_global_temp" style="text-align: center; width: 215px; background: linear-gradient(#34D32D -25.09%, #1DBC16 50%, #009B0F 75%, #1F7837 100%)" id="default_co2ok_temp">
                    <span class="make make_co2ok_default" style="color: white; text-align:center; margin-bottom: -2px; font-size: 18px; margin-left: 13px; text-transform: none;"><?php echo __( 'This purchase is', 'co2ok-for-woocommerce' ); ?></span>
    ...
    <span class="co2ok_payoff">
		...
		<div class="co2ok_infobox_container co2ok_cfp_container co2ok-popper" id="infobox-view">
            ...
            <div class="cfp-project cfp-hovercard">
                <?php echo co2ok_plugin_woocommerce\Components\Co2ok_HelperComponent::RenderImage('images/co2_projects.png', 'info-hover-png', 'cfp-project-img cfp-hovercard', 'a3-notlazy'); ?>
